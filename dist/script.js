...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "showErrorInputMessage", function() { return showErrorInputMessage; });
/* harmony import */ var _modals__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modals */ "./src/js/modules/modals.js");


const showErrorInputMessage = (placePutMessage, errorMessage = 'Error, enter correct data') => {
...
const balconyCalcModalTabs = state => {
  ...
  const validationBalconySize = () => {
    balconyPopupCalcBtn.addEventListener('click', () => {
      ...
      if (inputWidth && inputHeight && typeof inputWidth !== 'string' && typeof inputHeight !== 'string') {
  ...
  const choosingColdOrWarmBalcony = () => {
    popupCalcProfileBtn.addEventListener('click', () => {
      if (balconyCalcCheckbox[0].checked && !balconyCalcCheckbox[1].checked) {
        // Cold
...
/***/ "./src/js/modules/imageEnlargement.js":
/*!********************************************!*\
  !*** ./src/js/modules/imageEnlargement.js ***!
  \********************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (imageEnlargement);
...
/*!**********************************!*\
  !*** ./src/js/modules/modals.js ***!
  \**********************************/
/*! exports provided: closeModal, calcScroll, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
